...
import static com.oliyapir.videodownloader.allvideodownloader.util.Utils.RootDirectoryInsta;
...
import com.oliyapir.videodownloader.allvideodownloader.adapter.StoriesListAdapter;
import com.oliyapir.videodownloader.allvideodownloader.adapter.UserListAdapter;
import com.oliyapir.videodownloader.allvideodownloader.api.CommonClassForAPI;
import com.oliyapir.videodownloader.allvideodownloader.databinding.ActivityInstagramBinding;
import com.oliyapir.videodownloader.allvideodownloader.interfaces.UserListInterface;
import com.oliyapir.videodownloader.allvideodownloader.model.Edge;
import com.oliyapir.videodownloader.allvideodownloader.model.EdgeSidecarToChildren;
import com.oliyapir.videodownloader.allvideodownloader.model.FBStoryModel.NodeModel;
import com.oliyapir.videodownloader.allvideodownloader.model.ResponseModel;
import com.oliyapir.videodownloader.allvideodownloader.model.story.FullDetailModel;
import com.oliyapir.videodownloader.allvideodownloader.model.story.StoryModel;
...
public class GabInstagramActivity extends AppCompatActivity implements UserListInterface {
    private ActivityInstagramBinding binding;
    private GabInstagramActivity activity;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //AdsUtils.showGoogleBannerAd(GabInstagramActivity.this,binding.adView);
        //InterstitialAdsINIT();
            ...
            DisposableObserver<StoryModel>() {
                ...
                public void onNext(StoryModel response) {
                    ...
                    try {
                        ...
                        userListAdapter = new UserListAdapter(activity, arrayListTrayModel,activity);
    ...
    public void onBackPressed() {
        new BackInterAds().showInterAds(this, new BackInterAds.OnAdClosedListener() {
            ...
            public void onAdClosed() {
                GabInstagramActivity.super.onBackPressed();
            }
        });
    }
}
