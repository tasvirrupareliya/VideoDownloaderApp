...
import static com.oliyapir.videodownloader.allvideodownloader.util.Utils.RootDirectoryFacebook;
...
import com.oliyapir.videodownloader.allvideodownloader.adapter.FBStoriesListAdapter;
import com.oliyapir.videodownloader.allvideodownloader.adapter.FbStoryUserListAdapter;
...
import com.oliyapir.videodownloader.allvideodownloader.model.FBStoryModel.EdgesModel;
import com.oliyapir.videodownloader.allvideodownloader.model.FBStoryModel.MediaModel;
...
public class FacebookActivity extends AppCompatActivity implements UserListInterface {
    ...
    private void pasteText() {
        try {
            ...
            copyIntent = GabMainActivity.extractLinks(copyIntent);
