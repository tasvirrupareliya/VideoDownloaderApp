...
import static com.oliyapir.videodownloader.allvideodownloader.util.Utils.ROOTDIRECTORYMOJ;
...
import com.oliyapir.videodownloader.allvideodownloader.model.TiktokModel;
...
public class GabMojActivity extends AppCompatActivity {
    private LayoutGlobalUiBinding binding;
    GabMojActivity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new LargeNativeAds().loadNativeAds(GabMojActivity.this, null);
        new MiniNativeAds().loadNativeAds(GabMojActivity.this, null);
        new OpenAds().loadOpenAd();
        new InterAds().loadInterAds(GabMojActivity.this);
        new BackInterAds().loadInterAds(GabMojActivity.this);
    }
    ...
    public void onBackPressed() {
        new BackInterAds().showInterAds(this, new BackInterAds.OnAdClosedListener() {
            ...
            public void onAdClosed() {
                GabMojActivity.super.onBackPressed();
            }
        });
    }
}