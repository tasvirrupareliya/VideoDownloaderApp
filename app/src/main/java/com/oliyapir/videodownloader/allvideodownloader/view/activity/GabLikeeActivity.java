...
import static com.oliyapir.videodownloader.allvideodownloader.util.Utils.RootDirectoryLikeeShow;
import static com.oliyapir.videodownloader.allvideodownloader.util.Utils.createFileFolder;
import static com.oliyapir.videodownloader.allvideodownloader.view.activity.GabMainActivity.extractLinks;
...
public class GabLikeeActivity extends AppCompatActivity {
    LayoutGlobalUiBinding binding;
    GabLikeeActivity activity;
    ...
    public void onBackPressed() {
        new BackInterAds().showInterAds(this, new BackInterAds.OnAdClosedListener() {
            ...
            public void onAdClosed() {
                GabLikeeActivity.super.onBackPressed();
            }
        });
    }
}