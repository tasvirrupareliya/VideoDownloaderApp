...
import static com.oliyapir.videodownloader.allvideodownloader.util.Utils.RootDirectoryTwitter;
...
public class GabTwitterActivity extends AppCompatActivity {
    private LayoutGlobalUiBinding binding;
    GabTwitterActivity activity;
    ...
    public void onBackPressed() {
        new BackInterAds().showInterAds(this, new BackInterAds.OnAdClosedListener() {
            ...
            public void onAdClosed() {
                GabTwitterActivity.super.onBackPressed();
            }
        });
    }
}