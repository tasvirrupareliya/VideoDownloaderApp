...
import static com.oliyapir.videodownloader.allvideodownloader.util.Utils.ROOTDIRECTORYJOSH;
...
public class GabJoshActivity extends AppCompatActivity {
    LayoutGlobalUiBinding binding;
    GabJoshActivity activity;
    ...
    public void onBackPressed() {
        new BackInterAds().showInterAds(this, new BackInterAds.OnAdClosedListener() {
            ...
            public void onAdClosed() {
                GabJoshActivity.super.onBackPressed();
            }
        });
    }
}